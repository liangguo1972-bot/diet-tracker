...
describe('FR-001 response parsing', () => {
  it('keeps real matched, possible, unmatched and ignored states', () => {
    const result = parseReceiptImport({
      ...
      items: [
        { receiptItemId: 'a', position: 0, rawName: '牛奶', ingredientId: 'i-1', ingredientName: '牛奶', matchStatus: 'matched', confirmedName: '牛奶', confirmedQuantity: 1, confirmedUnit: '盒', storage: '冷藏', action: 'add_to_inventory' },
